...
export const metadata = {
  ...
  openGraph: {
    ...
    siteName: 'MotherHood Preschool & Daycare',
    locale: 'en_IN',
    images: [
      {
        url: logo.src,
