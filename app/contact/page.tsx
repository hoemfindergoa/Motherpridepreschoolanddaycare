        ...
        <div className="mx-auto max-w-7xl">
          ...
          >
            {contactItems.map((item) => (
              ...
              >
                <div
                  className={`mb-5 flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl transition-transform duration-300 group-hover:scale-110 ${item.tone === "rose" ? "bg-rose-50 text-rose-500" :
